    ...
    <div className="h-screen w-full relative bg-white">
      ...
      >
        {childArray.map((child, index) => {
          ...
          return (
            <SwiperSlide key={index} className={`h-screen w-full ${slideBg} box-border`}>
              <div className={`w-full h-full flex flex-col overflow-y-auto ${!isHero && !isFooter ? "pt-[100px] pb-6" : ""}`}>
                <div 
